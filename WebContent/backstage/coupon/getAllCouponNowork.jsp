...
<%
	...
	List<Order_MasterVO> list = omSvc.getAll().stream().filter(p -> p.getOrder_Master_State() == 0)
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview menu-open"><a href="#"
							class="nav-link active"> <i class="far fa-edit"></i>
								<p>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">訂單主檔</h1>
									...
									<div class="card card-primary card-tabs">
										...
										<div class="card-header p-0 pt-1">
											<ul class="nav nav-tabs" id="custom-tabs-one-tab"
												role="tablist">
												<li class="nav-item"><a class="nav-link "
													href="<%=request.getContextPath()%>/backstage/getAllOrder_Master.jsp">使用中</a></li>
												<li class="nav-item"><a class="nav-link active"
													href="<%=request.getContextPath()%>/backstage/getAllOrder_MasterNobuy.jsp">停用中</a></li>
											...
											<tbody>
												...
												<c:forEach var="omVO" items="${list}" begin="<%=pageIndex%>"
													...
													<tr>
														...
														<td>${omVO.coupon_ID}</td>
														<td>${omVO.order_Master_Payment}</td>
														<c:forEach var="memVO" items="${AllmVO}">
															<c:if test="${memVO.member_ID eq omVO.member_ID}">
																...
																<%-- 														<td>${empVO.emp_Est_Time}</td> --%>
															</c:if>

														</c:forEach>
														<td><fmt:formatDate value="${omVO.order_Master_TimeStamp}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
