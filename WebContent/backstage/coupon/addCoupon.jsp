		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">新增優惠券</h1>
											...
											<table>
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control col-2 "
														...
														value="<%=(cpVO == null) ? "爺爺使把勁" : cpVO.getCoupon_Name()%>"
														name="cp_Name" />
												</div>
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control col-2 "
														...
														value="<%=(cpVO == null) ? "0.75" : cpVO.getCoupon_Class()%>"
														name="cp_Class" />
												</div>
															...
															<div class="input-group-prepend">
																<div class="input-group-text">
																	<input type="radio" name="cp_State"
																		...
																		value="1"
																		<%=(cpVO == null) ? "checked" : (cpVO.getCoupon_State() == 1) ? "checked" : ""%> />使用中
																	<input type="radio" name="cp_State"
																		aria-label="Radio button for following text input"
																		value="0"
												...
												<div class="input-group mb-3">
													...
													<input type="text" id="Numbertext"
														...
														value="<%=(cpVO == null) ? "" : cpVO.getCoupon_Number()%>"
														name="cp_Number" />
					...
					: cpVO.getCoupon_Info()%>"
											...
											<button type="button" class="btn">
												...
												<input type="hidden" name="action" value="insert"> <input
													class="btn btn-secondary active" type="submit" value="送出新增">
