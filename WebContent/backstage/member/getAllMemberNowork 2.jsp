...
<%
	...
	List<MemberVO> list = memSvc.getAll().stream().filter(p -> p.getMember_State() == 0)
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">會員查詢</h1>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="search_area">
							<FORM METHOD="post"
								ACTION="<%=request.getContextPath()%>/backstage/member/member.do">

								<input type="text" id="search" name="mem_ID"
									placeholder="請輸入會員編號" value="${mem_ID}" /> <input
							...
							<br> <br> <a class="col" style="color: red">${errorMsgs.mem_ID}</a>
											...
											<tbody>
												...
												<c:forEach var="memVO" items="${list}"
													...
													<tr>
														...
														<td><img id="myImg"
															src="<%=request.getContextPath()%>/member/ShowImage?member_ID=${memVO.member_ID}"
