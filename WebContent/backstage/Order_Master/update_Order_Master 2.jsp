							...
							<div class="card-title">
								...
								<div class="card-body" style="overflow: auto">
									<div class="col-lg">
										...
										<br>
										<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1">付款方式:<%=omVO.getOrder_Master_Payment()%>
											</span>
										</div>
										<br>
										...
										<FORM METHOD="post" class="form1"
											...
											<table>
												...
												<c:choose>
													<c:when test="<%=(omVO.getOrder_Master_State() == 1)%>">


														<div class="input-group mb-3">
															<div class="input-group">
																<div class="input-group-prepend">
																	<span class="input-group-text" id="basic-addon1">訂單狀態:</span>

																	<div class="input-group-prepend">
																		<div class="input-group-text">
																			<input type="radio" name="order_Master_State"
																				id="Nobuy"
																				aria-label="Radio button for following text input"
																				value="0"
																				<%=(omVO.getOrder_Master_State() == 0) ? "checked" : ""%> />取消
																			<input type="radio" name="order_Master_State"
																				id="buy"
																				aria-label="Radio button for following text input"
																				value="1"
																				<%=(omVO != null && omVO.getOrder_Master_State() == 1) ? "checked" : ""%> />正常
																		</div>
																		<br>
																		<p class="col" style="color: red">${errorMsgs.order_Master_State}</p>
																	</div>
																</div>
															</div>
														</div>
														...
														<button type="button" class="btn">
															...
															<input type="hidden" name="order_Master_ID"
																value="<%=omVO.getOrder_Master_ID()%>"> <input
																type="hidden" name="order_Master_Date"
																value="<%=omVO.getOrder_Master_TimeStamp()%>"> <input
																type="hidden" name="member_ID"
																value="<%=omVO.getMember_ID()%>"> <input
																type="hidden" name="coupon_ID"
																value="<%=omVO.getCoupon_ID()%>"> <input
																type="hidden" name="order_Master_Payment"
																value="<%=omVO.getOrder_Master_Payment()%>"> <input
																class="btn btn-secondary active" id="gogo" type="submit"
																value="送出">
													...
													<c:otherwise>
														...
														<div class="input-group-prepend">
															<span class="input-group-text" id="basic-addon1">訂單狀態:已取消!
															</span>
														</div>

														<br>

														<input type="button" class="btn btn-secondary active"
															value="返回"
															onclick="location.href='<%=request.getContextPath()%>/backstage/Order_Master/getAllOrder_MasterNobuy.jsp'">
