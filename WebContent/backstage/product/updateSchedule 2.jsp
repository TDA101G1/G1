...
<%
	...
	String day2 = "";
	String day3 = "";
	System.out.println(pVO.getProduct_Total_Schedule());
	if (pVO.getProduct_Total_Schedule() != null) {
// 	if (!"".equals(pVO.getProduct_Total_Schedule())) {
		
		String Total = pVO.getProduct_Total_Schedule();
		System.out.print("total: " + Total);
		String[] parts = Total.split("Dayys");
	...
	pageContext.setAttribute("day1", day1);
	pageContext.setAttribute("day2", day2);
	pageContext.setAttribute("day3", day3);
%>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">修改套裝</h1>
										...
										<FORM METHOD="post"
												...
												<div class="container">
													...
													<div id="googleMap">
														<iframe width="600" height="450" frameborder="0"
															style="border: 0"
															src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBPJRhviSK2E8-7hm5IIc1HLh0PbmPeTEA&q=`+<%=pVO.getProduct_County()%>+`"
											...
											<button type="button" class="btn">
												<input type="hidden" name="product_Seq"
													value="<%=pVO.getProduct_Seq()%>"> <input
													type="hidden" name="product_click_rec"
													...
													type="hidden" name="product_Class" value="套裝行程"> <input
													type="hidden" name="action" value="updateSchedule">
