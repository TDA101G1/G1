		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">修改商品</h1>
									...
									<div class="col-lg">
										...
										<FORM METHOD="post"
											...
											<table>
												...
												<div class="container">
													...
													<br>
																					...
																					<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon1">商品明細編號:<%=pdVO.getProduct_Detail_ID()%>
														</span>
													...
													<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon1">商品點擊數:<%=pVO.getProduct_Click_Rec()%>
														</span>
													...
													<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon1">商品購買數:<%=pVO.getProduct_Sale_Rec()%>
														</span>
													...
													<div class="input-group mb-3">
														...
														<select name="product_County" class="city">
															<option value="基隆市"
																<%=(pVO.getProduct_County().equals("基隆市")) ? "selected" : ""%>>基隆市</option>
															<option value="臺北市"
																<%=(pVO.getProduct_County().equals("臺北市")) ? "selected" : ""%>>臺北市</option>
															<option value="新北市"
																<%=(pVO.getProduct_County().equals("新北市")) ? "selected" : ""%>>新北市</option>
															<option value="宜蘭縣"
																<%=(pVO.getProduct_County().equals("宜蘭縣")) ? "selected" : ""%>>宜蘭縣</option>
															<option value="新竹市"
																<%=(pVO.getProduct_County().equals("新竹市")) ? "selected" : ""%>>新竹市</option>
															<option value="新竹縣"
																<%=(pVO.getProduct_County().equals("新竹縣")) ? "selected" : ""%>>新竹縣</option>
															<option value="桃園市"
																<%=(pVO.getProduct_County().equals("桃園市")) ? "selected" : ""%>>桃園市</option>
															<option value="苗栗縣"
																<%=(pVO.getProduct_County().equals("苗栗縣")) ? "selected" : ""%>>苗栗縣</option>
															<option value="臺中市"
																<%=(pVO.getProduct_County().equals("臺中市")) ? "selected" : ""%>>臺中市</option>
															<option value="彰化縣"
																<%=(pVO.getProduct_County().equals("彰化縣")) ? "selected" : ""%>>彰化縣</option>
															<option value="南投縣"
																<%=(pVO.getProduct_County().equals("南投縣")) ? "selected" : ""%>>南投縣</option>
															<option value="嘉義市"
																<%=(pVO.getProduct_County().equals("嘉義市")) ? "selected" : ""%>>嘉義市</option>
															<option value="嘉義縣"
																<%=(pVO.getProduct_County().equals("嘉義縣")) ? "selected" : ""%>>嘉義縣</option>
															<option value="雲林縣"
																<%=(pVO.getProduct_County().equals("雲林縣")) ? "selected" : ""%>>雲林縣</option>
															<option value="臺南市"
																<%=(pVO.getProduct_County().equals("臺南市")) ? "selected" : ""%>>臺南市</option>
															<option value="高雄市"
																<%=(pVO.getProduct_County().equals("高雄市")) ? "selected" : ""%>>高雄市</option>
															<option value="屏東縣"
																<%=(pVO.getProduct_County().equals("屏東縣")) ? "selected" : ""%>>屏東縣</option>
															<option value="臺東縣"
																<%=(pVO.getProduct_County().equals("臺東縣")) ? "selected" : ""%>>臺東縣</option>
															<option value="花蓮縣"
																<%=(pVO.getProduct_County().equals("花蓮縣")) ? "selected" : ""%>>花蓮縣</option>
															<option value="金門縣"
																<%=(pVO.getProduct_County().equals("金門縣")) ? "selected" : ""%>>金門縣</option>
															<option value="連江縣"
																<%=(pVO.getProduct_County().equals("連江縣")) ? "selected" : ""%>>連江縣</option>
															<option value="澎湖縣"
																<%=(pVO.getProduct_County().equals("澎湖縣")) ? "selected" : ""%>>澎湖縣</option>
														</select>
													</div>
													...
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control col-6 "
															...
															id="Address" value="<%=pVO.getProduct_Address()%>"
													...
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control col-1 "
															...
															id="lng" value="<%=pVO.getProduct_Longitude()%>"
													...
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control col-1 "
															...
															id="lat" value="<%=pVO.getProduct_Latitutde()%>"
													...
													<div id="googleMap">
														<iframe width="600" height="450" frameborder="0"
															style="border: 0"
															src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBPJRhviSK2E8-7hm5IIc1HLh0PbmPeTEA&q=`+<%=pVO.getProduct_Address()%>+`"
													...
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control col-6 "
															placeholder="Name" aria-describedby="basic-addon1"
															value="<%=pVO.getProduct_Intro()%>" name="product_Intro" />
													</div>
													...
													<div class="input-group mb-3">
														...
														<textarea class="form-control"
															...
															id="exampleFormControlTextarea1" rows="1"><%=pVO.getProduct_Total_Schedule()%></textarea>
													...
													<div class="input-group mb-3">
														...
														<textarea class="form-control" name="product_Info"
															id="exampleFormControlTextarea1" rows="3"><%=pVO.getProduct_Info()%></textarea>
													...
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control col-2 "
															...
															value="<%=pdVO.getProduct_Detail_Spc()%>"
													...
													<div class="input-group mb-3">
														...
														<input type="number" min="0" max="99999"
															...
															value="<%=pdVO.getProduct_Detail_Money()%>"
													...
													<div class="input-group mb-3">
														...
														<input type="number" min="0" max="999"
															...
															aria-describedby="basic-addon1"
															value="<%=pdVO.getProduct_Detail_Instock()%>"
													...
													<div class="input-group mb-3">
														...
														<input type="number" min="0" max="999"
															...
															aria-describedby="basic-addon1"
															value="<%=pdVO.getProduct_Detail_Saftystock()%>"
											...
											<input type="hidden" name="product_Seq"
													value="<%=pVO.getProduct_Seq()%>">
												<input type="hidden" name="product_click_rec"
													value="<%=pVO.getProduct_Click_Rec()%>"> <input
													type="hidden" name="product_sale_rec"
													value="<%=pVO.getProduct_Sale_Rec()%>"> <input
													type="hidden" name="productDatile_ID"
													value="<%=pdVO.getProduct_Detail_ID()%>"> <input
													type="hidden" name="product_ID"
													value="<%=pVO.getProduct_ID()%>"> <input
