					...
					<div class="row">
						...
						<div class="search_area">
							<FORM METHOD="post"
								...
								<input type="text" id="search" name="p_ID" placeholder="請輸入商品編號"
									value="<%=(pVO == null) ? "" : pVO.getProduct_ID()%>" /> <input
									type="hidden" name="pd_ID" value="${pdVO.product_Detail_ID}">
									...
									<div class="col-lg">
										<table class="table table-sm-12 ">
											...
											<tbody>
												...
												<c:forEach var="pdVO" items="${list}" begin="<%=pageIndex%>"
														...
														<td>
															<FORM METHOD="post"
																...
																<input type="hidden" name="pd_ID"
																	value="${pdVO.product_Detail_ID}"> <input
