							...
							<div class="card-title">
								...
								<div class="card-body" style="overflow: auto">
									...
									<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon1">員工編號:<%=empVO.getEmp_ID() %>
														</span>
					...
					<table>
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control col-6 "
								...
								value="<%=empVO.getEmp_Pwd()%>"
								name="emp_Pwd" />
						</div>
						<p style="color: red">${errorMsgs.getEmp_Pwd}</p>
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control col-6 " id="f_date2"
								placeholder="Address" aria-describedby="basic-addon1" value="<%=empVO.getEmp_Birth()%>" 
								name="emp_Birth" />
						</div>
