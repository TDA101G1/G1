										...
										<div class="card-header p-0 pt-1">
											<ul class="nav nav-tabs" id="custom-tabs-one-tab"
												...
												<li class="nav-item"><a class="nav-link active"
													href="<%=request.getContextPath()%>/backstage/employee/getAllEMP.jsp">使用中</a></li>
												<li class="nav-item"><a class="nav-link"
													href="<%=request.getContextPath()%>/backstage/employee/getAllEMPnowork.jsp">停用中</a></li>
											...
											<tbody>
												...
												<c:forEach var="empVO" items="${list}"
													...
													<tr>
														...
														<td>${empVO.emp_Pwd}</td>
														<td>${empVO.emp_Grade.equals("0")?'員工':'主管'}</td>
														<td>${empVO.emp_Sex.equals("M")?'男生':'女生'}</td>
